...
export async function POST(request: Request) {
  ...
  serverLogger.info("creative.video.completed", { provider, mode: result.mode, generationType: "AI_VIDEO", model: result.model, isDummy: result.isDummy ?? result.mode === "DUMMY", jobId: job?.id, outputSource: result.outputSource, errorMessage: runtimeInfo.warning ?? result.warning });
